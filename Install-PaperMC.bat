@echo off
:: Script to install PaperMC for Minecraft

:: Set variables
set "output_folder=PaperMC Files"
set "base_url=https://api.papermc.io/v2/projects/paper"

:: Check if the output folder exists; if not, create it
if not exist "%output_folder%" (
    echo Creating the folder for PaperMC files...
    mkdir "%output_folder%"
)
...
if exist "%output_folder%\paper-%mc_version%-%build_number%.jar" (
    echo Download successful! PaperMC file saved to "%output_folder%".
) else (
